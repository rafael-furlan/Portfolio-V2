          ...
          <div className="flex items-start justify-between mb-10">
            ...
            <div className="flex flex-row gap-3 items-center pt-1">
              <a
                ...
                className="flex items-center justify-center w-6 h-6 rounded-md bg-[#F2F2F2] hover:bg-[#E8E8E8] transition-colors"
               
              >
                <svg width="13" height="13" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className="fill-[#3D3D3D]">
          ...
          <div className="mb-16">
            <div className="flex flex-col gap-[13px]">
              <p className="text-gray-900 text-base leading-relaxed">
                Everyone calls me Rafa /ˈha.fɐ/
              </p>
              <p className="text-gray-900 text-base leading-relaxed text-balance">
                Staff Product Designer at <a href="https://superfiliate.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#3D3D3D] transition-colors">Superfiliate</a>, leading the Meta partnership vertical and building the design system as a design engineer. Trained as a designer, spending the last two years learning to build. Before this: tried to start a food-tech company, learned more from the failure than I expected. Moved into fintech as a design consultant. Then joined a logistics startup as the only designer and built the design foundation from zero.
              </p>
              <p className="text-gray-900 text-base leading-relaxed">
                Currently building the system that ships the product.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            {projects.map((project, index) => (
              <Fragment key={index}>
                ...
                >
                  <div className="w-[80px] h-[64px] min-w-[80px] shrink-0">
                    <img
                      src={project.image}
                      className="w-full h-full rounded-[5px] object-cover object-left-top"
                    />
                  </div>
                ...
                {index < projects.length - 1 && <div className="h-px bg-gray-200" />}
              </Fragment>
            ))}
          </div>
