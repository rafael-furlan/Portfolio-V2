...
function HeaderButton1() {
  ...
  return (
    <div onClick={handleClick} className="flex items-center justify-center min-w-[70px] max-w-[70px] min-h-[70px] max-h-[70px] rounded-full bg-gray-600/20 backdrop-blur-md hover:bg-gray-600/40 active:bg-gray-600/60 transition-all duration-300">
        <svg
            width="20"
            height="20"
            viewBox="0 0 16 16"
            ...
            className={`w-[20px] h-[20px] transition-colors duration-300 ${getIconColor()}`}
        >
